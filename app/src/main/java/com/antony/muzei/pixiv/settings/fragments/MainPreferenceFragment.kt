...
import com.antony.muzei.pixiv.provider.PixivProviderConst
...
class MainPreferenceFragment : PreferenceFragmentCompat() {
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        updateModePref!!.onPreferenceChangeListener = Preference.OnPreferenceChangeListener setOnPreferenceChangeListener@{ _: Preference?, newValue: Any ->
            ...
            if (isAuthUpdateMode && sharedPrefs.getString(PixivProviderConst.PREFERENCE_PIXIV_ACCESS_TOKEN, "")!!.isEmpty()) {
        ...
        if (sharedPrefs.getString(PixivProviderConst.PREFERENCE_PIXIV_ACCESS_TOKEN, "")!!.isEmpty()) {
        ...
        loginActivityPreference.onPreferenceClickListener = Preference.OnPreferenceClickListener {
            if (sharedPrefs.getString(PixivProviderConst.PREFERENCE_PIXIV_ACCESS_TOKEN, "")!!.isEmpty()) {
                ...
                editor.remove("name")
                editor.remove(PixivProviderConst.PREFERENCE_PIXIV_ACCESS_TOKEN)
